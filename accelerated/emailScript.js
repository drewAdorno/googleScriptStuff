    ...
    if (Session.getActiveUser().getEmail() == "dadorno@codingdojo.com" || Session.getActiveUser().getEmail() == "program-status@codingdojo.com") {
        ...
        if (result === SpreadsheetApp.getUi().Button.OK) {
            for (let student of emailStudents) {
                ...
                let message = generateMessage(curr_student, offset, assignment_column, discussion_column, stack, curr_week, ssm_name, ssm_email, instructor);
...
function generateMessage(curr_student, offset, assignment_column, discussion_column, stack, curr_week, ssm_name, ssm_email, instructor) {
